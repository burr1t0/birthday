...
const GUESTS = {
  ...
  "ЕЛКА": {
    ...
    emoji: "✨",
    message: `
      <p>Братец кролик, приглашаю тебя на свой день рождения, бери с собой хорошее настроение и счастливую моську</p>
    `
  },
  ...
  "ЮРЕЦ ОГУРЕЦ": {
    ...
    emoji: "🌸",
    message: `
      <p>Юрка, Юрец, вас приветствует организация "ООО тмыв денег" или как говорят в простонародье - приглашаю тебя на свой день рождения, также уведомляем, что персонально для вас работает акция +1, только для вас и только в нашей компании)</p>
    `
  },
  ...
  "ВРЕДИНА МЕЛКАЯ)": {
    ...
    emoji: "💕",
    message: `
      <p>Ну что моя дорога жопанька, приглашаю тебя на праздник, попу мой, себя собирай, жду тебя  красивой (ты всегда красивая) ну и воть...</p>
    `
  },
  ...
  "ТРОПИКАНА ЖЕНЩИНА": {
    ...
    emoji: "🎀",
    message: `
      <p>Моя дорогая, приглашаю тебя на свой день рождения, собирайся, попу мой и вылетай ко мне на праздник❤️</p>
    `
  },
  ...
  "АХМАТ МОУСЕН": {
    ...
    emoji: "🌙",
    message: `
      <p>Хехе, здравствуйте уважаемый Артём, вы попали в бюро "финансовые траты" или как говорят люди - вас позвали на день рождения)</p>
